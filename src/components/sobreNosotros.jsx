...
function SobreNosotros() {
  return (
    <div>
        <Navbar1/>
        <h1 className='texto1'>Conoce al equipo de The wild project.</h1>
        <Card
